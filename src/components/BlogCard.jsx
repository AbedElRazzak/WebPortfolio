...
export default function BlogCard(props) {
    ...
    <div className="bg-primasry-400 msy-8 p-4 flex justify-center items-center">
        <div className="flex flex-col lg:flex-row bg-secondary-300 w-full px-4 py-20 rounded-2xl">
          ...
          <div className={`bg-primsary-50 pb-10 md:pl-12 lg:pl-20 order-${props.order1}`}>
          ...
          <div className={`flex justify-center items-center max-w-lg order-${props.order2}`}>
          ...
          <div className="hidden lg:flex flex-col  justify-center items-center bg-primasry-100 lg:items-start lg:justify-start lg:pl-16">
            ...
            <div className="w-full md:pl-12 lg:pl-16">
              <a target="_blank" href={props.link} className={`h-8 w-fit bg-accent-${props.clr == 1 ? "blue" : "pink"}-400 p-2 px-6 flex justify-center items-center rounded-2xl cursor-pointer hover:bg-accent-${props.clr == 1 ? "blue-300" : "pink-300"} ease-in-out`}>
